...
public class LDAPTest {
  ...
  manager-password="wIaH3IYw"/>
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldaps://devldap3.capella.edu:636";
        final String ldapSearchBase = "ou=serviceAccounts,dc=capella,dc=edu";
        
        final String ldapUsername = "uid=TomcatReadAdmin,ou=ouAdmins,dc=capella,dc=edu";
        final String ldapPassword = "wIaH3IYw";
        
        final String ldapAccountToLookup = "it.pccp";
       ...
       System.out.println( ctx.lookup("it.pccp"));
